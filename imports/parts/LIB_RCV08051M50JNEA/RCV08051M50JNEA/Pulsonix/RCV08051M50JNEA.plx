...
//20202922/1620765/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "RCV08051M50JNEA" (originalName "RCV08051M50JNEA")
	...
	(compDef "RCV08051M50JNEA" (originalName "RCV08051M50JNEA") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RCV08051M50JNEA"))
		...
		(attr "Mouser Part Number" "71-RCV08051M50JNEA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Draloric/RCV08051M50JNEA?qs=hWgE7mdIu5S0Ry5mXWPolg%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "RCV08051M50JNEA")
		(attr "Description" "Thick Film Resistors - SMD RCV0805 200 1M5 5% ET1 E3")
		(attr "<Hyperlink>" "https://www.vishay.com/doc?20054")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "RCV08051M50JNEA.stp")
