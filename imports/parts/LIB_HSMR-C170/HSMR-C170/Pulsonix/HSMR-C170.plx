...
(library Library_1
	...
	(patternDef "LEDC2012X90N" (originalName "LEDC2012X90N")
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.875 1.15) (pt 1.875 1.15) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 1.875 1.15) (pt 1.875 -1.15) (width 0.05))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt 0.95 1.05) (pt -1.775 1.05) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.775 1.05) (pt -1.775 -1.05) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.775 -1.05) (pt 0.95 -1.05) (width 0.2))
		)
	)
	(symbolDef "HSMR-C170" (originalName "HSMR-C170")
	...
	(compDef "HSMR-C170" (originalName "HSMR-C170") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "HSMR-C170"))
		...
		(attr "Mouser Part Number" "630-HSMR-C170")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Broadcom-Avago/HSMR-C170?qs=YDL0qNrpDT75U8LW5zK4Qg%3D%3D")
		(attr "Manufacturer_Name" "Avago Technologies")
		(attr "Manufacturer_Part_Number" "HSMR-C170")
		(attr "Description" "LED Uni-Color Blue 469nm 2-Pin Chip LED T/R - Tape and Reel")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/dk/DKDS-25/484042.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "HSMR-C170.stp")
